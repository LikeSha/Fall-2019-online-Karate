...
#     header - represents header of response
  # this part :  response.places[0].['place name'] == 'Beverly Hills' if property has space in between, like this :
  # place name --> then we need to put entire property place name inside a squre bracket []
